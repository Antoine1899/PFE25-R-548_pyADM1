...
# -------------------------------------------------------------
influent_state = pd.read_csv("digester_influent_test2.csv", sep=';')
...
simulate_results['V_ch4_cumul'] = ((simulate_results['q_ch4'] * dt)/104.4).cumsum()
# -------------------------------------

# Sauvegarde du fichier CSV complet
simulate_results.to_csv("dynamic_out_test2.csv", index = False, sep=';')
...
try:
    ...
    pyOut = pd.read_csv("dynamic_out_test2.csv", sep=';')
