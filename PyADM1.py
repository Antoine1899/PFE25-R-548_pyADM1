...
# -------------------------------------------------------------
influent_state = pd.read_csv("digester_influent_test8.csv", sep=';')
...
simulate_results.to_csv("dynamic_out_test8.csv", index = False, sep=';')
...
try:
    ...
    pyOut = pd.read_csv("dynamic_out_test8.csv", sep=';')
