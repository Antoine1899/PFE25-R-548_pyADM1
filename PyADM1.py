...
# -------------------------------------------------------------
influent_state = pd.read_csv("digester_influent_test4.csv", sep=';')
...
simulate_results['V_ch4_cumul'] = ((simulate_results['q_ch4'] * dt)/93.13).cumsum()
# -------------------------------------

# Sauvegarde du fichier CSV complet
simulate_results.to_csv("dynamic_out_test4.csv", index = False, sep=';')
...
try:
    ...
    pyOut = pd.read_csv("dynamic_out_test4.csv", sep=';')
